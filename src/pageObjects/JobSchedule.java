...
public class JobSchedule extends BaseClass{


	public JobSchedule(WebDriver driver) {
		super(driver);
	...
	{          
		...
		try{
			...
			if((exphour>=syshour) || (expDate!=currentDate)){
	...
	public static int hourCalculation(int c){
	...
	public static int minuteCalculation(int c){
	...
	public static int endHourCalculation(int c){
		//		   endhrs++ ;
	...
	public static int endMinuteCalculation(int c){
