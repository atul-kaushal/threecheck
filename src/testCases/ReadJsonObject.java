...
//	URL url = new URL("http://maps.googleapis.com/maps/api/geocode/json?address=chicago&sensor=false&#8221");
			...
			URL url = new URL("http://ec2-54-218-89-35.us-west-2.compute.amazonaws.com/threecheck/rest/Job/searchForAllJob?&orderBy=modifiedTime&orderType=desc&ulimit=9&llimit=0");			
			
	HttpURLConnection conn = (HttpURLConnection) url.openConnection();
	conn.setRequestMethod("GET");
	conn.setRequestProperty("Accept", "application/json");
conn.setRequestProperty("token","g9aqe2kkmivqb3voqje411oi8j") ;
